...
private:
	...
	arma::cx_mat rho_dot(potential& HH, arma::vec E0, arma::vec E_exp, arma::mat Dvt, arma::vec Gl, arma::vec Gr, arma::cx_mat rho0);
	arma::cx_mat Lrho(potential& HH, arma::vec E_exp, arma::vec Gl, arma::vec Gr, arma::cx_mat rho0);
